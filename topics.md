...
| `owner` | `sin`, `:user-id` | `sin`  | :x: | Filters the list of topics by their owner. As of now, only topics created by SIN are available.|   `?owner=:user-id`|
...
```
{
    ...
    defaultTags: ["tidxx1, "tidxx2"] // Tags for this topic.
}
```
...
```
{
    ...
    defaultTags: ["tidxx1, "tidxx6"] // Tags for this topic.
}
```
